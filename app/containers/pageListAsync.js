...
export const Contest = Loadable({
  loader: () => import('./RtfTextModule/Contest'),
  loading: Loading,
});

export const ScratchContest = Loadable({
  loader: () => import('./RtfScratchModule/Contest'),
  loading: Loading,
});

export const ScratchExpired = Loadable({
  loader: () => import('./RtfScratchModule/Expired'),
  loading: Loading,
});


export const LiveContest = Loadable({
  loader: () => import('./RtfLiveModule/Contest'),
  loading: Loading,
});

export const LiveExpired = Loadable({
  loader: () => import('./RtfLiveModule/Expired'),
  loading: Loading,
});



export const TodaysContest = Loadable({
  loader: () => import('./RtfLiveModule/Todays'),
  loading: Loading,
});
...
export const Merchant = Loadable({
  loader: () => import('./RtfShopable/Contest'),
  loading: Loading,
});
 
export const Cart = Loadable({
  loader: () => import('./RtfShopable/Cart'),
  loading: Loading,
});
...
export const Expired = Loadable({
  loader: () => import('./RtfTextModule/Expired'),
  loading: Loading,
});
...
export const Property = Loadable({
  loader: () => import('./RtfTextModule/Property'),
  loading: Loading,
});

export const Reward = Loadable({
  loader: () => import('./RtfTextModule/Reward'),
  loading: Loading,
});

export const Category = Loadable({
  loader: () => import('./RtfTextModule/Category'),
  loading: Loading,
});
...
export const QuestionBank = Loadable({
  loader: () => import('./RtfTextModule/QuestionBank'),
  loading: Loading,
});


export const MasterQuestionBank = Loadable({
  loader: () => import('./RtfTextModule/MasterQuestionBank'),
  loading: Loading,
});
