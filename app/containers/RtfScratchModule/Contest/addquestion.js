...
if(this.props.ansType==="FEEDBACK"){
    URL="snwAddContQuest.json?clId="+this.props.clId+"&coId="+this.props.coId+"&qstText="+this.state.qstText+"&ansType="+this.props.ansType+"&optA="+this.state.opa+"&optB="+this.state.opb+"&optC="+this.state.opc+"&optD="+this.state.opd+"&orient="+this.state.orient;
  }else{
    if(!this.state.ans){
        message.error("Selecting an answer is mandatory!");
      return;
    }
    URL="snwAddContQuest.json?clId="+this.props.clId+"&coId="+this.props.coId+"&qstText="+this.state.qstText+"&ansType="+this.props.ansType+"&optA="+this.state.opa+"&optB="+this.state.opb+"&optC="+this.state.opc+"&optD="+this.state.opd+"&orient="+this.state.orient+"&ans="+this.state.ans;
  }
  // if(this.props.);
...
addCat=()=>{
  ...
  getCat=(loadingIndicator)=>{
    const {fil}=this.state
     ...
     CALL_API("post",API_URL+"snwgetAllContQust.json?clId=AMIT202002CID&coId="+this.props.coId+"&pgNo="+this.state.pgNo+"&cau="+udata.userid+"&hfilter="+fil).then((res)=>{
     if(res.data.ottresp.sts===0){
       // this.setState({
          ...
          <div style={{width:'100%',padding:10}}>
            ...
            <div className="flex_div" style={{flex:1,alignItems:"center"}}>
             ...
             <RadioGroup style={{display:"flex",flexDirection:"row"}} 
                    error={!this.state.orient && showError}
             aria-label="gender" name="orient" value={this.state.orient} onChange={this.handleRadio}>    
            ...
            <div style={{paddingLeft:10,paddingRight:10,flex:1}}>
              <FormControl style={{width:'100%'}} className={classes.formControl}>
                ...
                <Input 
                    ...
                    id="name-simple" name="opb" value={this.state.opb} onChange={this.handleChange} />
...
<div className="flex_div">
            <div style={{paddingLeft:10,paddingRight:10,flex:1}}>
              <FormControl style={{width:'100%'}} className={classes.formControl}>
                ...
                <Input id="name-simple" name="opc" value={this.state.opc} onChange={this.handleChange} />
            ...
            <div style={{paddingLeft:10,paddingRight:10,flex:1}}>
              <FormControl style={{width:'100%'}} className={classes.formControl}>
                ...
                <Input id="name-simple" name="opd" value={this.state.opd} onChange={this.handleChange} />
              </FormControl>
            </div>
              </div>
