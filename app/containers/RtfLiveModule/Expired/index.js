...
import Addproduct from '../Contest/addproduct';
...
slectTheme=(thmId)=>{
  ...
  getContest=(loadingd)=>{
    ...
    CALL_API("post",API_URL+"livegetallcontests.json?clId=AMIT202002CID&sts=EXPIRED&pgNo="+this.state.pgNo+"&hfilter="+fil).then((res)=>{
  //console.log(res);
  if(res.data.liveresp.sts===0){
          message.error(res.data.liveresp.msg);
     }
