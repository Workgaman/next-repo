...
!file
  ...
  var URL="shopaddmerchantproduct.json?clId=AMIT202002CID&prodname="+prodname+"&proddesc="+proddesc+"&unitvalue="+unitvalue+"&priceperunit="+priceperunit+"&unittype="+unittype+"&prodimageurl="+prodimageurl+"&mercid="+this.props.mercId+"&prodidselrsite="+prodidselrsite;
  ...
  CALL_API("post",API_URL+URL,data).then((res)=>{
    ...
    message.error(res.data.shopresp.msg);
      ...
      document.getElementById('file-simple').value="";
...
if(file){  
  ...
  var URL="shopeditmerchantproduct.json?clId=AMIT202002CID&prodname="+prodname+"&proddesc="+proddesc+"&unitvalue="+unitvalue+"&priceperunit="+priceperunit+"&unittype="+unittype+"&prodimageurl="+prodimageurl+"&mercid="+this.props.mercId+"&prodidselrsite="+prodidselrsite+"&mercProdid="+mercProdid+"&isimgupd="+isimgupd;
  ...
  CALL_API("post",API_URL+URL,data).then((res)=>{
    ...
    if(res.data.shopresp.sts===0){
       this.setState({
         errorMsg:res.data.shopresp.msg,
         isError:true
       })
     }
    this.props.showSnackbar(res.data.shopresp.msg);
...
addCat=()=>{
  ...
  getCat=(loadingIndicator)=>{
    const {fil}=this.state
     ...
     CALL_API("post",API_URL+"shoplistallmerchantproducts.json?clId=AMIT202002CID&sts=ACTIVE&mercid="+this.props.mercId+"&pgNo="+this.state.pgNo+"&cau="+udata.userid+"&hfilter="+fil).then((res)=>{
     if(res.data.shopresp.sts===0){
       // this.setState({
...
deleteContest=async (id)=>{
 ...
 if(!cnf){
  ...
  var d=datas.filter((e,i)=>{
   ...
   console.log(d);
   const {mercId,mercProdid,clintId}=d;
      CALL_API("post",API_URL+"shopdeletemerchantproduct.json?cau="+udata.userid+"&clId="+JSON.parse(localStorage.user_data).clId+"&mercid="+mercId+"&mercProdid="+mercProdid).then((res)=>{
      // console.log(res);
      if(res.data.shopresp.sts===0){
      // this.props.showSnackbar(res.data.shopresp.msg);
...
<Snackbar
         ...
         <Tabs
          ...
          <div style={{width:'100%',padding:10}}>
            ...
            <FormControl style={{width:'100%'}} className={classes.formControl}>
              ...
              {!this.state.prodname && showError && <span className="err">This field is required.</span>}
          ...
          <div style={{paddingLeft:10,paddingRight:10,width:'100%'}}>
            <FormControl style={{width:'100%'}} className={classes.formControl}>
               ...
               {!this.state.proddesc && showError && <span className="err">This field is required.</span>}
              </FormControl>
              </div>
            </div>
            ...
            <FormControl style={{width:'100%'}} className={classes.formControl}>
                ...
                <Input type="tel" id="name-simple" name="unitvalue" value={this.state.unitvalue} onChange={this.handleChange} />
              {!this.state.unitvalue && showError && <span className="err">This field is required.</span>}
            ...
            <FormControl style={{width:'100%'}} className={classes.formControl}>
                ...
                <Input type="tel" id="name-simple" name="priceperunit" value={this.state.priceperunit} onChange={this.handleChange} />
           {!this.state.priceperunit && showError && <span className="err">This field is required.</span>}
 ...
 <div style={{paddingLeft:10,paddingRight:10,width:'100%'}}>
            <FormControl style={{width:'100%'}} className={classes.formControl}>
                ...
                <Input id="name-simple" name="unittype" value={this.state.unittype} onChange={this.handleChange} />
           {!this.state.priceperunit && showError && <span className="err">This field is required.</span>}
              </FormControl>
              </div>
        ...
        <div style={{paddingLeft:10,paddingRight:10,marginTop:16,width:'100%'}}>
                <Input type="file" id="file-simple" name="file"  onChange={this.handleFilechange} />
              {!this.state.file && !this.state.isEdit && showError && <span className="err">This field is required.</span>}
     ...
     <div style={{paddingLeft:10,paddingRight:10,width:'100%'}}>
            <FormControl style={{width:'100%'}} className={classes.formControl}>
              ...
              {!this.state.prodidselrsite && showError && <span className="err">This field is required.</span>}
              </FormControl>
              </div>
            </div>
